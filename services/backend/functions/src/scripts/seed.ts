...
async function main() {
  ...
  const venues = [
    ...
    },
    {
      ...
      photoCount: 15,
      placeTags: ['Healthy', 'Salads', '$$', '1.1 km'],
      phone: '+33 1 42 60 18 18',
      website: 'lejardinsalad.fr',
      openingHours: [{ day: 'Daily', hours: '11 AM – 10 PM' }],
      popularDishes: [{ name: 'Green garden salad', rating: 4.8 }, { name: 'Caesar salad', rating: 4.6 }],
      priceLevel: 2,
      distanceKm: 1.1,
      rating: 4.6,
      reviewCount: 137,
