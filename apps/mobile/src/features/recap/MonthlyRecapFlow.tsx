...
export function MonthlyRecapFlow({ mode = 'ready', onClose, user }: MonthlyRecapFlowProps) {
  ...
  const storyBackground = step === 'placeGuess' || step === 'placeResult' ? starsBackground : pattern;

  return (
    <View style={styles.screen}>
      <LinearGradient colors={['#560E0B', '#260706', '#080808']} locations={[0, 0.52, 1]} style={StyleSheet.absoluteFill} />
      <ImageBackground source={storyBackground} resizeMode="cover" imageStyle={styles.pattern} style={StyleSheet.absoluteFill}>
        {progress ? <StoryProgress completed={progress} /> : null}
        <CloseButton onPress={() => setConfirmingClose(true)} />
...
function CloseButton({ onPress }: { onPress: () => void }) {
  ...
  return (
    ...
    >
      <CloseCircle height={24} width={24} />
      <CloseX height={7} style={styles.closeX} width={7} />
    </Pressable>
  );
}
  ...
  return (
    <>
      ...
      <View style={styles.ratingArc}>
        ...
        <View style={styles.ratingCategoryMain}><Text style={styles.ratingCategoryGlyph}>🍴</Text></View>
        <View style={styles.ratingCategory}><Text style={styles.ratingCategoryGlyph}>▽</Text></View>
      </View>
...
const createStyles = (colors: ThemeColors, isDark: boolean) => {
  ...
  lockIcon: { width: 47, height: 60, tintColor: '#FFFFFF' },
  centerTitle: { color: '#FFFFFF', fontSize: 26, lineHeight: 32, fontWeight: '700', textAlign: 'center' },
  centerSubtitle: { maxWidth: 360, color: '#AAB2C5', fontSize: 15, lineHeight: 21, textAlign: 'center' },
  introHeader: { position: 'absolute', top: 122, left: 16, right: 16, alignItems: 'center' },
  introTitle: { color: '#FFFFFF', fontSize: 28, fontWeight: '700', letterSpacing: 0.6, marginBottom: 16 },
  ...
  ratingPin: { position: 'absolute', top: -25, alignSelf: 'center', backgroundColor: '#AD3324', borderWidth: 1, borderColor: '#FFFFFF', borderRadius: 20, paddingHorizontal: 8, paddingVertical: 6 },
  ratingPinText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' },
  introCaption: { position: 'absolute', left: 16, right: 16, bottom: 101, color: '#AAB2C5', fontSize: 16, textAlign: 'center' },
  questionContent: { position: 'absolute', top: 263, left: 16, right: 16 },
  screenHeading: { alignItems: 'center', gap: 8 },
  screenHeadingTitle: { color: '#FFFFFF', fontSize: 24, lineHeight: 29, fontWeight: '700', letterSpacing: 0.6, textAlign: 'center' },
  screenHeadingSubtitle: { color: '#AAB2C5', fontSize: 16, lineHeight: 18, textAlign: 'center' },
  answerList: { marginTop: 15, gap: 7 },
  answerCard: { height: 69, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: 'rgba(184,47,41,0.48)', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  ...
  resultTitle: { position: 'absolute', top: 117, left: 16, right: 16, color: '#FFFFFF', fontSize: 24, fontWeight: '700', textAlign: 'center' },
  ...
  placeSheet: { position: 'absolute', top: 235, left: 0, right: 0, bottom: 0, borderTopLeftRadius: 24, borderTopRightRadius: 24, borderTopWidth: 1, borderColor: '#FFFFFF', backgroundColor: 'rgba(15,5,5,0.75)', overflow: 'hidden' },
  placeList: { padding: 16, paddingBottom: 110, gap: 8 },
  placeCard: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  placeCardCompact: { minHeight: 120, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: 'rgba(255,255,255,0.04)', padding: 10, gap: 24 },
  ...
  placeTitle: { color: '#FFFFFF', fontSize: 16, lineHeight: 21, fontWeight: '600' },
  placeAddress: { color: '#AAB2C5', fontSize: 14 },
  ...
  areaOption: { color: '#FFFFFF', fontSize: 18, fontWeight: '600' },
  areaRule: { flex: 1, height: StyleSheet.hairlineWidth, backgroundColor: 'rgba(255,255,255,0.35)' },
  ...
  areaResultTitle: { color: '#FFFFFF', fontSize: 24, fontWeight: '700' },
  areaResultPlace: { color: '#AAB2C5', fontSize: 18, fontWeight: '600' },
  ...
  ratingCategory: { width: 55, height: 55, borderRadius: 28, backgroundColor: '#3A0C0B', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', alignItems: 'center', justifyContent: 'center' },
  ratingCategoryMain: { width: 74, height: 74, marginTop: -46, borderRadius: 37, backgroundColor: '#B82F29', borderWidth: 2, borderColor: 'rgba(255,255,255,0.1)', alignItems: 'center', justifyContent: 'center' },
  ...
  ratingPlaceTitle: { color: '#FFFFFF', fontSize: 17, lineHeight: 22, fontWeight: '500', textAlign: 'center' },
  ratingAddress: { color: '#AAB2C5', fontSize: 15, textAlign: 'center' },
  ratingFeedback: { position: 'absolute', top: 188, left: 40, right: 40, color: '#FFFFFF', fontSize: 24, fontWeight: '700', textAlign: 'center' },
  ...
  feedbackMarkWrong: { backgroundColor: '#161616' },
  ...
  dishRow: { minHeight: 64, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.2)', flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 8 },
  dishAvatar: { width: 40, height: 40, borderRadius: 20, borderWidth: 1, borderColor: '#FFFFFF' },
  dishName: { flex: 1, color: '#FFFFFF', fontSize: 15, fontWeight: '600' },
  followersContent: { position: 'absolute', top: 314, left: 21, right: 21, alignItems: 'center', gap: 14 },
  avatarStack: { flexDirection: 'row', alignItems: 'center' },
  initialAvatar: { width: 48, height: 48, borderRadius: 24, borderWidth: 2, borderColor: '#5D1715', alignItems: 'center', justifyContent: 'center' },
  initialText: { color: '#FFFFFF', fontSize: 16, fontWeight: '600' },
  followerCount: { color: '#FFFFFF', fontSize: 52, lineHeight: 58, fontWeight: '700' },
  followerCaption: { color: 'rgba(255,255,255,0.6)', fontSize: 16, lineHeight: 21 },
  ...
  comparisonRow: { minHeight: 57, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'rgba(255,255,255,0.08)', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  ...
  cta: { position: 'absolute', zIndex: 15, left: 35, right: 35, bottom: 24, height: 54, borderRadius: 36, borderWidth: 5, borderColor: '#4C1816', backgroundColor: '#B82F29', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  shareRays: { position: 'absolute', top: -134, left: -31, width: '126%', height: 440 },
  ...
  recapTitle: { marginTop: 29, color: '#FFFFFF', fontSize: 20, fontWeight: '700', letterSpacing: 0.6, textAlign: 'center' },
  metrics: { marginTop: 0 },
  metricRow: { height: 58, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'rgba(255,255,255,0.2)', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  metricLabel: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  metricIcon: { width: 20, height: 20 },
  metricText: { color: '#FFFFFF', fontSize: 16 },
  ...
  shareHeading: { marginTop: 14, color: 'rgba(255,255,255,0.6)', fontSize: 15, fontWeight: '600' },
  shareOptions: { marginTop: 18, gap: 10 },
  shareOption: { minHeight: 50, paddingHorizontal: 18, borderRadius: 25, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', backgroundColor: '#161616', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  shareOptionLabel: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  shareIcon: { width: 20, height: 20 },
  shareText: { color: '#FFFFFF', fontSize: 16 },
  chevron: { color: '#AAB2C5', fontSize: 28, fontWeight: '300', marginTop: -2 },
  pressed: { opacity: 0.78 },
  scrim: { flex: 1, justifyContent: 'flex-end', paddingHorizontal: 16, paddingBottom: 18, backgroundColor: 'rgba(0,0,0,0.55)' },
  sheet: { height: 236, borderRadius: 22, backgroundColor: '#242424', alignItems: 'center', paddingHorizontal: 16 },
  handle: { marginTop: 10, width: 36, height: 4, borderRadius: 2, backgroundColor: '#555555' },
  sheetTitle: { marginTop: 14, color: '#FFFFFF', fontSize: 18, fontWeight: '600' },
  sheetCopy: { marginTop: 8, maxWidth: 310, color: '#AAB2C5', fontSize: 14, lineHeight: 19, textAlign: 'center' },
  ...
  keepLabel: { color: '#FFFFFF', fontSize: 16, fontWeight: '600' },
    leaveLabel: { marginTop: 16, color: '#AAB2C5', fontSize: 16 },
  });
};
