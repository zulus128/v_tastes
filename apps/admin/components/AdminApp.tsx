  ...
  return (
    <main className="login-shell">
      ...
      <form className="login-card" onSubmit={submit}>
        <div className="brand brand-large"><img className="brand-icon" src="/admin-brand.png" alt="" /><span>Tastes</span></div>
...
export function AdminApp() {
  ...
  if (!role) return <main className="access-denied"><div className="brand brand-large"><img className="brand-icon" src="/admin-brand.png" alt="" /><span>Tastes</span></div><h1>Access restricted</h1><p>This account does not have an admin or moderator role.</p><button className="button primary" onClick={() => signOut(getFirebaseAuth())}>Sign out</button></main>;

  return <div className="app-shell">
    <aside>
      <div className="brand"><img className="brand-icon" src="/admin-brand.png" alt="" /><span>Tastes</span><em>Admin</em></div>
